...
export async function updateSession(request: NextRequest) {
  ...
  if (user) {
    ...
    if (isAdminPage || isMemberPage) {
      ...
      // Protect /admin routes from ordinary members
      ...
      // Optionally, you can also protect /member routes from admins if you want strict separation,
      // but usually admins can see member areas. If you want strict:
      // if (isMemberPage && isSaccoAdmin) {
      //   const url = request.nextUrl.clone();
      //   url.pathname = '/admin';
      //   return NextResponse.redirect(url);
      // }
